const WelcomePage = () => {
  return (
    <div
      className="text-xl text-red-500 h-screen flex items-center justify-center bg-cover bg-center"
    ...
    >
      <div className="text-center">
        ...
        <div className="flex justify-between gap-50">
          <button className="btn lg:w-[265px] lg:h-[68px] rounded-full  mt-6 mx-auto flex justify-between items-center px-4 py-2">
